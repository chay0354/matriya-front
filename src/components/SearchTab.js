...
const SEARCH_SCOPE_HINT =
    'אפשר לשאול בעברית או באנגלית (התשובה תהיה באותה שפה). בהשוואת פורמולציות/אחוזים עדיף לבקש טבלת Markdown: רכיב | % A | % B | Δ (B−A) / Component | % A | % B | Δ (B−A) — רק לפי המסמכים שנבחרו.';
        ...
        <div className="search-tab">
                ...
                <div className="search-box">
                    <input
                        ...
                        placeholder="הכנס שאילתת חיפוש... / Ask in Hebrew or English"
                        className="search-input"
                ...
                <div className="search-options">
                    ...
                    <p className="stage-hint" style={{ marginTop: '8px' }}>
                        {SEARCH_SCOPE_HINT}
                    </p>
                </div>
